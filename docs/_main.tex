...
\urlstyle{same}
\hypersetup{
  pdftitle={RNA-seq Analysis Using Galaxy en Français 2025},
  pdfauthor={Faculty: Virginie Calderon, Caroline Grou, Ludovic Malet, Gaspard Reulet},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{RNA-seq Analysis Using Galaxy en Français 2025}
...
Welcome to the 2025 RNA-seq Analysis Using Galaxy en Français Canadian Bioinformatics Workshop webpage!
